...
namespace SharpCAD.DatabaseServices.Filer
{
    ...
    public abstract class XmlFiler
    {
        ...
        public abstract bool Write(string name, SharpCAD.Colors.Color color);
        public abstract bool Write(string name, ObjectId value);
        public abstract bool Write(string name, SharpCAD.DatabaseServices.LineWeight value);
        public abstract bool Write(string name, SharpCAD.DatabaseServices.LineType value);
        ...
        public abstract bool Read(string name, out SharpCAD.Colors.Color color);
        public abstract bool Read(string name, out ObjectId value);
        public abstract bool Read(string name, out SharpCAD.DatabaseServices.LineWeight value);
        public abstract bool Read(string name, out SharpCAD.DatabaseServices.LineType value);
    }
}
