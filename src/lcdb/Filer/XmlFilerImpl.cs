...
namespace SharpCAD.DatabaseServices.Filer
{
    /// <summary>
    ...
    internal class XmlFilerImpl : XmlFiler
    {
        ...
        public override bool Write(string name, SharpCAD.Colors.Color value)
        {
            return _Write(name, value);
        }
        ...
        public override bool Write(string name, SharpCAD.DatabaseServices.LineWeight value)
        {
            return _Write(name, value);
        }

        public override bool Write(string name, SharpCAD.DatabaseServices.LineType value)
        {
            return _Write(name, value);
        }
        ...
        public override bool Read(string name, out SharpCAD.Colors.Color value)
        {
            XmlNode node = _curXmlNode.SelectSingleNode(name);
            if (node == null)
            {
                value = SharpCAD.Colors.Color.ByLayer;
                return false;
            }

            return SharpCAD.Colors.Color.TryParse(node.InnerText, out value);
        }
        ...
        public override bool Read(string name, out SharpCAD.DatabaseServices.LineWeight value)
        {
            XmlNode node = _curXmlNode.SelectSingleNode(name);
            if (node == null)
            {
            ...
            value = (LineWeight)Enum.Parse(
                typeof(SharpCAD.DatabaseServices.LineWeight), node.InnerText, true);
            return true;
        }

        public override bool Read(string name, out SharpCAD.DatabaseServices.LineType value)
        {
            XmlNode node = _curXmlNode.SelectSingleNode(name);
            if (node == null)
            {
            ...
            value = (LineType)Enum.Parse(
                typeof(SharpCAD.DatabaseServices.LineType), node.InnerText, true);
            return true;
        }
    }
}
