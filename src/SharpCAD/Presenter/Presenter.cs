...
namespace SharpCAD
{
    ...
    internal class Presenter : IPresenter
    {
        ...
        private void TestData()
        {
            ...
            line.color = SharpCAD.Colors.Color.FromColor(Color.Green); ;
            modelSpace.AppendEntity(line);

            Circle circle = new Circle();
            circle.center = new LitMath.Vector2(0, 0);
            circle.radius = 20;
            circle.color = SharpCAD.Colors.Color.FromColor(Color.Blue);
            modelSpace.AppendEntity(circle);

            Polyline polyline = new Polyline();
            polyline.color = SharpCAD.Colors.Color.FromColor(Color.Yellow);
            ...
            Arc arc = new Arc();
            arc.color = SharpCAD.Colors.Color.FromColor(Color.Blue);
            ...
            //text.alignment = SharpCAD.DatabaseServices.TextAlignment.RightBottom;
